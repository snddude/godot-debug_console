...
func _enter_tree() -> void:
	...
	if !ProjectSettings.has_setting("input/toggle_debug_console"):
		...
		dialog.set_text(
				...
				+ "Input Map tab until another Action has been added or the Project has been "
				+ "reloaded.")
		dialog.ok_button_text = "Reload Project"
